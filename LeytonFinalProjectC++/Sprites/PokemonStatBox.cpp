...
public:
	...
	PokemonStatBox(int _originalSizeX, int _originalSizeY, float _xStart, float _yStart, float _width, float _height) : Sprite(SpriteType::SpriteTypes::PokemonStatBox, _xStart, _yStart, _width, _height, "../LeytonFinalProjectC++/Sprites/BattleSprites/PokemonStatBox.png") {
